...
- **Synthetic credit union demo generator** in
  ...
  seed writes are skipped without failing.
...
```bash
bruin validate --fast credit-union/pipelines/credit_union_dwh
```
...
bruin run --full-refresh --start-date 2015-01-01 --end-date 2026-06-23 \
  credit-union/pipelines/credit_union_dwh
```
...
storage when running historical full refreshes.
...
bruin run --start-date 2015-01-01 --end-date 2015-01-02 \
  credit-union/pipelines/credit_union_dwh/assets/bronze/seed_salesforce_demo_data.py
```
...
```bash
bruin run --full-refresh credit-union/pipelines/credit_union_dwh/assets/bronze/salesforce_accounts.asset.yml
bruin run --full-refresh credit-union/pipelines/credit_union_dwh/assets/bronze/salesforce_contacts.asset.yml
bruin run --full-refresh credit-union/pipelines/credit_union_dwh/assets/bronze/salesforce_leads.asset.yml
bruin run --full-refresh credit-union/pipelines/credit_union_dwh/assets/bronze/salesforce_campaigns.asset.yml
bruin run --full-refresh credit-union/pipelines/credit_union_dwh/assets/bronze/salesforce_campaign_members.sql
bruin run --full-refresh credit-union/pipelines/credit_union_dwh/assets/bronze/salesforce_users.asset.yml
bruin run --full-refresh credit-union/pipelines/credit_union_dwh/assets/bronze/salesforce_products.asset.yml
bruin run --full-refresh credit-union/pipelines/credit_union_dwh/assets/bronze/salesforce_pricebooks.asset.yml
bruin run --full-refresh credit-union/pipelines/credit_union_dwh/assets/bronze/salesforce_pricebook_entries.asset.yml
bruin run --full-refresh credit-union/pipelines/credit_union_dwh/assets/bronze/salesforce_opportunities.asset.yml
bruin run --full-refresh credit-union/pipelines/credit_union_dwh/assets/bronze/salesforce_opportunity_contact_roles.asset.yml
bruin run --full-refresh credit-union/pipelines/credit_union_dwh/assets/bronze/salesforce_opportunity_line_items.asset.yml
bruin run --full-refresh credit-union/pipelines/credit_union_dwh/assets/bronze/salesforce_tasks.asset.yml
bruin run --full-refresh credit-union/pipelines/credit_union_dwh/assets/bronze/salesforce_events.asset.yml
```

Build silver and gold tables:

```bash
bruin run credit-union/pipelines/credit_union_dwh/assets/silver/salesforce_opportunity_pipeline.sql
bruin run credit-union/pipelines/credit_union_dwh/assets/silver/salesforce_account_health.sql
bruin run credit-union/pipelines/credit_union_dwh/assets/silver/salesforce_product_pipeline.sql
bruin run credit-union/pipelines/credit_union_dwh/assets/silver/salesforce_marketing_funnel.sql
bruin run credit-union/pipelines/credit_union_dwh/assets/silver/salesforce_activity_timeline.sql
bruin run credit-union/pipelines/credit_union_dwh/assets/gold/pipeline_kpis.sql
bruin run credit-union/pipelines/credit_union_dwh/assets/gold/pipeline_by_stage.sql
bruin run credit-union/pipelines/credit_union_dwh/assets/gold/pipeline_by_channel_daily.sql
bruin run credit-union/pipelines/credit_union_dwh/assets/gold/pipeline_by_channel_monthly.sql
bruin run credit-union/pipelines/credit_union_dwh/assets/gold/activity_coverage_by_product.sql
bruin run credit-union/pipelines/credit_union_dwh/assets/gold/product_pipeline_performance.sql
bruin run credit-union/pipelines/credit_union_dwh/assets/gold/campaign_conversion_funnel.sql
bruin run credit-union/pipelines/credit_union_dwh/assets/gold/branch_relationship_health.sql
bruin run credit-union/pipelines/credit_union_dwh/assets/gold/banker_activity_coverage.sql
```

Or run downstream once the bronze objects are populated:

```bash
bruin run --downstream credit-union/pipelines/credit_union_dwh/assets/bronze/salesforce_accounts.asset.yml
bruin run --downstream credit-union/pipelines/credit_union_dwh/assets/bronze/salesforce_opportunities.asset.yml
```
...
- The pipeline start date is now `2015-01-01`. Long full-refresh seed runs now
  ...
  be high in small Salesforce dev orgs.
...
- All bronze Salesforce extract assets depend on
  ...
  step as the upstream source generator and seed failures stop the extract
  layer.
...
- Command: `CREDIT_UNION_ACCOUNTS_PER_DAY=1 CREDIT_UNION_CONTACTS_PER_ACCOUNT=1 CREDIT_UNION_OPPORTUNITIES_PER_ACCOUNT=1 CREDIT_UNION_TASKS_PER_OPPORTUNITY=1 CREDIT_UNION_LEADS_PER_DAY=1 CREDIT_UNION_EVENTS_PER_OPPORTUNITY=1 bruin run --start-date 2026-06-23 --end-date 2026-06-24 credit-union/pipelines/credit_union_dwh`
...
- `bruin format credit-union/pipelines/credit_union_dwh` passed.
- `python3 -m py_compile .../seed_salesforce_demo_data.py` passed.
- `bruin internal parse-asset` passed for all 11 assets.
- `bruin validate --fast credit-union/pipelines/credit_union_dwh` and the requested
...
- `bruin validate --fast credit-union/pipelines/credit_union_dwh` passed for
  all 11 assets.
