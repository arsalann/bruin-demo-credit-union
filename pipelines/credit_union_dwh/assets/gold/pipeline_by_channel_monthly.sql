...
type: sf.sql
description: |
  Monthly open and won pipeline by lead source and Opportunity test tier for
  the Credit Union Salesforce demo dashboard.
...
domains:
  ...
  - lending
meta:
  asset_grain: One row per close month, lead source, and Opportunity test tier.
